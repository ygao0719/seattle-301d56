...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT. Rando is a variable only working insede while loop. If you call Rando outside while loop, the machine thinks Rando is not defined. 
  console.log(viewed);
